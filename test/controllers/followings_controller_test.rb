...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { following_user_id: @following.following_user_id, requester_user_id: @following.requester_user_id, tfalse: @following.tfalse } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { following_user_id: @following.following_user_id, requester_user_id: @following.requester_user_id, tfalse: @following.tfalse } }
