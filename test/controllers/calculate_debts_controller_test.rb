...
class CalculateDebtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculate_debt" do
    assert_difference('CalculateDebt.count') do
      post calculate_debts_url, params: { calculate_debt: { compounds_per_year: @calculate_debt.compounds_per_year, email: @calculate_debt.email, monthly_payements: @calculate_debt.monthly_payements, number_of_year: @calculate_debt.number_of_year, principle: @calculate_debt.principle, rate: @calculate_debt.rate, select: @calculate_debt.select } }
    end
  ...
  test "should update calculate_debt" do
    patch calculate_debt_url(@calculate_debt), params: { calculate_debt: { compounds_per_year: @calculate_debt.compounds_per_year, email: @calculate_debt.email, monthly_payements: @calculate_debt.monthly_payements, number_of_year: @calculate_debt.number_of_year, principle: @calculate_debt.principle, rate: @calculate_debt.rate, select: @calculate_debt.select } }
