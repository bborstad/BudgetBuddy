...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { following: @follow.following, requestor: @follow.requestor } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { following: @follow.following, requestor: @follow.requestor } }
